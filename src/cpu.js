...
function CPU(bus, wm, next_tick_immediately)
{
    ...
    // 64-bit long mode EFER MSR and related state
    this.efer = v86util.view(Int32Array, memory, 1248, 1);
    this.msr_star = v86util.view(Int32Array, memory, 1252, 1);
    this.msr_lstar_low = v86util.view(Int32Array, memory, 1256, 1);
    this.msr_lstar_high = v86util.view(Int32Array, memory, 1260, 1);
    this.msr_fmask = v86util.view(Int32Array, memory, 1264, 1);
    this.is_64 = v86util.view(Uint8Array, memory, 1268, 1);
